...
def get_index():
    if check_for_name() != '':
        if iscolab:
            ...
            logs_path="/content/drive/MyDrive/Retrieval-based-Voice-Conversion-WebUI/logs/"+chosen_model
...
def get_indexes():
    indexes_list=[]
    if iscolab:
        for dirpath, dirnames, filenames in os.walk("/content/drive/MyDrive/Retrieval-based-Voice-Conversion-WebUI/logs/"):
...
def match_index(speaker):
    ...
    parent_dir="/content/drive/MyDrive/Retrieval-based-Voice-Conversion-WebUI/logs/"+folder
